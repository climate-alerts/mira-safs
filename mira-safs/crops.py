...
def load_data():
    ...
    crops_data = pd.read_csv(os.path.join('assets', 'crops_data.csv'))
    soil_data = pd.read_csv(os.path.join('assets', 'soil_data.csv'))
    pest_pathogen_data = pd.read_csv(os.path.join('assets', 'pest_pathogen_data.csv'))
    fertilizers_data = pd.read_csv(os.path.join('assets', 'fertilizers_data.csv'))
